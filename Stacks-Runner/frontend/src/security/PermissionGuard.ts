...
/**
 * PermissionGuard - Security and authentication module
 * @module services/PermissionGuard
 */
...
export class PermissionGuard extends EventEmitter {
  private opts: PermissionGuardOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<PermissionGuardOptions> = {}) {
    super();
