...
/**
 * OAuthHandler - Security and authentication module
 * @module services/OAuthHandler
 */
...
export class OAuthHandler extends EventEmitter {
  private opts: OAuthHandlerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<OAuthHandlerOptions> = {}) {
    super();
