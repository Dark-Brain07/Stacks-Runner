...
/**
 * PasswordHasher - Security and authentication module
 * @module services/PasswordHasher
 */
...
export class PasswordHasher extends EventEmitter {
  private opts: PasswordHasherOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<PasswordHasherOptions> = {}) {
    super();
