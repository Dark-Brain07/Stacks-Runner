...
/**
 * CaptchaService - Security and authentication module
...
export class CaptchaService extends EventEmitter {
  private opts: CaptchaServiceOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<CaptchaServiceOptions> = {}) {
    super();
