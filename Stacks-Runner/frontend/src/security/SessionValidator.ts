...
/**
 * SessionValidator - Security and authentication module
 * @module services/SessionValidator
 */
...
export class SessionValidator extends EventEmitter {
  private opts: SessionValidatorOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SessionValidatorOptions> = {}) {
    super();
