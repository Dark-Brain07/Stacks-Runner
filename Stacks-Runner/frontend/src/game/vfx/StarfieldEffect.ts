...
/**
 * StarfieldEffect - Visual effect renderer
 * @module services/StarfieldEffect
 */
...
export class StarfieldEffect extends EventEmitter {
  private opts: StarfieldEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<StarfieldEffectOptions> = {}) {
    super();
