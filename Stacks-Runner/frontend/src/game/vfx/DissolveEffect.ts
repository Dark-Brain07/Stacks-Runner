...
/**
 * DissolveEffect - Visual effect renderer
 * @module services/DissolveEffect
 */
...
export class DissolveEffect extends EventEmitter {
  private opts: DissolveEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<DissolveEffectOptions> = {}) {
    super();
