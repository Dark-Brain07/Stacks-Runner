...
/**
 * LightningEffect - Visual effect renderer
 * @module services/LightningEffect
 */
...
export class LightningEffect extends EventEmitter {
  private opts: LightningEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<LightningEffectOptions> = {}) {
    super();
