...
/**
 * LaserEffect - Visual effect renderer
 * @module services/LaserEffect
 */
...
export class LaserEffect extends EventEmitter {
  private opts: LaserEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<LaserEffectOptions> = {}) {
    super();
