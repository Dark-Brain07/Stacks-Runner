...
/**
 * WarpEffect - Visual effect renderer
 * @module services/WarpEffect
 */
export interface WarpEffectOptions {
  enabled: boolean;
  maxRetries: number;
  timeoutMs: number;
  batchSize: number;
...
export class WarpEffect extends EventEmitter {
  private opts: WarpEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<WarpEffectOptions> = {}) {
    super();
