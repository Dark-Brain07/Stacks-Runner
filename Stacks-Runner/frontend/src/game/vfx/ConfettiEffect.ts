...
/**
 * ConfettiEffect - Visual effect renderer
 * @module services/ConfettiEffect
 */
...
export class ConfettiEffect extends EventEmitter {
  private opts: ConfettiEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ConfettiEffectOptions> = {}) {
    super();
