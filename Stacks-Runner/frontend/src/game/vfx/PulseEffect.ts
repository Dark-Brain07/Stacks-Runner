...
/**
 * PulseEffect - Visual effect renderer
 * @module services/PulseEffect
 */
...
export class PulseEffect extends EventEmitter {
  private opts: PulseEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<PulseEffectOptions> = {}) {
    super();
