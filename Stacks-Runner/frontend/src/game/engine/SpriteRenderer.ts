...
/**
 * SpriteRenderer - Game engine subsystem
 * @module services/SpriteRenderer
 */
...
export class SpriteRenderer extends EventEmitter {
  private opts: SpriteRendererOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SpriteRendererOptions> = {}) {
    super();
