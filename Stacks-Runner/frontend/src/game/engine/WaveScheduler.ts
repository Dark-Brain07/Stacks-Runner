...
/**
 * WaveScheduler - Game engine subsystem
 * @module services/WaveScheduler
 */
...
export class WaveScheduler extends EventEmitter {
  private opts: WaveSchedulerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<WaveSchedulerOptions> = {}) {
    super();
