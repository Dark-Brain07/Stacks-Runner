...
/**
 * HUDOverlay - Game engine subsystem
 * @module services/HUDOverlay
 */
...
export class HUDOverlay extends EventEmitter {
  private opts: HUDOverlayOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<HUDOverlayOptions> = {}) {
    super();
