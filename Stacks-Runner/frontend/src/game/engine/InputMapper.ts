...
/**
 * InputMapper - Game engine subsystem
 * @module services/InputMapper
 */
...
export class InputMapper extends EventEmitter {
  private opts: InputMapperOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<InputMapperOptions> = {}) {
    super();
