...
/**
 * CollisionDetector - Game engine subsystem
 * @module services/CollisionDetector
 */
...
export class CollisionDetector extends EventEmitter {
  private opts: CollisionDetectorOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<CollisionDetectorOptions> = {}) {
    super();
