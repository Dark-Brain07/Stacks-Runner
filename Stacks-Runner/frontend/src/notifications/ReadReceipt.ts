...
/**
 * ReadReceipt - Notification system component
 * @module services/ReadReceipt
 */
...
export class ReadReceipt extends EventEmitter {
  private opts: ReadReceiptOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ReadReceiptOptions> = {}) {
    super();
