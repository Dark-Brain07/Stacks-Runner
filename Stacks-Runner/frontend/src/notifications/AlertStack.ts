...
/**
 * AlertStack - Notification system component
 * @module services/AlertStack
 */
...
export class AlertStack extends EventEmitter {
  private opts: AlertStackOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<AlertStackOptions> = {}) {
    super();
