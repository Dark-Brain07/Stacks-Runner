...
/**
 * ReferralTracker - Social feature service
 * @module services/ReferralTracker
 */
...
export class ReferralTracker extends EventEmitter {
  private opts: ReferralTrackerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ReferralTrackerOptions> = {}) {
    super();
