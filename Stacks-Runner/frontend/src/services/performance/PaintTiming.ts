...
/**
 * PaintTiming - Performance monitoring module
 * @module services/PaintTiming
 */
export interface PaintTimingOptions {
  enabled: boolean;
  maxRetries: number;
  timeoutMs: number;
  batchSize: number;
...
export class PaintTiming extends EventEmitter {
  private opts: PaintTimingOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<PaintTimingOptions> = {}) {
    super();
