...
/**
 * LayoutShift - Performance monitoring module
 * @module services/LayoutShift
 */
...
export class LayoutShift extends EventEmitter {
  private opts: LayoutShiftOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<LayoutShiftOptions> = {}) {
    super();
