...
/**
 * HeapSnapshot - Performance monitoring module
 * @module services/HeapSnapshot
 */
...
export class HeapSnapshot extends EventEmitter {
  private opts: HeapSnapshotOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<HeapSnapshotOptions> = {}) {
    super();
