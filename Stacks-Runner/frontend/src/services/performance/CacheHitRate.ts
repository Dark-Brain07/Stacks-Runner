...
/**
 * CacheHitRate - Performance monitoring module
 * @module services/CacheHitRate
 */
...
export class CacheHitRate extends EventEmitter {
  private opts: CacheHitRateOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<CacheHitRateOptions> = {}) {
    super();
