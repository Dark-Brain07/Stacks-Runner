...
/**
 * QuestEngine - Quest and progression service
 * @module services/QuestEngine
 */
...
export class QuestEngine extends EventEmitter {
  private opts: QuestEngineOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<QuestEngineOptions> = {}) {
    super();
