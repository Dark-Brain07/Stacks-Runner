...
/**
 * LevelCurve - Quest and progression service
 * @module services/LevelCurve
 */
...
export class LevelCurve extends EventEmitter {
  private opts: LevelCurveOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<LevelCurveOptions> = {}) {
    super();
