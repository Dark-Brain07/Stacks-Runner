...
/**
 * InventoryManager - Economy and inventory management
 * @module services/InventoryManager
 */
...
export class InventoryManager extends EventEmitter {
  private opts: InventoryManagerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<InventoryManagerOptions> = {}) {
    super();
