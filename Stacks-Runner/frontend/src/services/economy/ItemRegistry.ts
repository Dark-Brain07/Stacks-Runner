...
/**
 * ItemRegistry - Economy and inventory management
 * @module services/ItemRegistry
 */
...
export class ItemRegistry extends EventEmitter {
  private opts: ItemRegistryOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ItemRegistryOptions> = {}) {
    super();
