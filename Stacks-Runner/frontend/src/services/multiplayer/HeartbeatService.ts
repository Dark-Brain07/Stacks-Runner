...
/**
 * HeartbeatService - Multiplayer networking service
 * @module services/HeartbeatService
 */
...
export class HeartbeatService extends EventEmitter {
  private opts: HeartbeatServiceOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<HeartbeatServiceOptions> = {}) {
    super();
