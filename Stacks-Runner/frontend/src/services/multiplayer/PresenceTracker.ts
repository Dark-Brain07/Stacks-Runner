...
/**
 * PresenceTracker - Multiplayer networking service
 * @module services/PresenceTracker
 */
...
export class PresenceTracker extends EventEmitter {
  private opts: PresenceTrackerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<PresenceTrackerOptions> = {}) {
    super();
