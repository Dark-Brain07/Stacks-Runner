...
/**
 * ChatDispatcher - Multiplayer networking service
 * @module services/ChatDispatcher
 */
...
export class ChatDispatcher extends EventEmitter {
  private opts: ChatDispatcherOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ChatDispatcherOptions> = {}) {
    super();
