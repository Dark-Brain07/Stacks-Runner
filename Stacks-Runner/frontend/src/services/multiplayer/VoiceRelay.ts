...
/**
 * VoiceRelay - Multiplayer networking service
 * @module services/VoiceRelay
 */
...
export class VoiceRelay extends EventEmitter {
  private opts: VoiceRelayOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<VoiceRelayOptions> = {}) {
    super();
