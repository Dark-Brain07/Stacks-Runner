...
/**
 * ConnectionPool - Multiplayer networking service
 * @module services/ConnectionPool
 */
...
export class ConnectionPool extends EventEmitter {
  private opts: ConnectionPoolOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ConnectionPoolOptions> = {}) {
    super();
