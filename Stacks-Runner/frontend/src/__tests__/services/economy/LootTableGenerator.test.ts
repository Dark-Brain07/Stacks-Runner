...
import { LootTableGenerator } from '../../../services/economy/LootTableGenerator';

describe('LootTableGenerator', () => {
  let svc: LootTableGenerator;
  beforeEach(() => { svc = new LootTableGenerator(); });
