...
/**
 * SoundPool - Audio system component
 * @module services/SoundPool
 */
...
export class SoundPool extends EventEmitter {
  private opts: SoundPoolOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SoundPoolOptions> = {}) {
    super();
