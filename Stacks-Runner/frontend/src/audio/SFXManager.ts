...
/**
 * SFXManager - Audio system component
 * @module services/SFXManager
 */
...
export class SFXManager extends EventEmitter {
  private opts: SFXManagerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SFXManagerOptions> = {}) {
    super();
