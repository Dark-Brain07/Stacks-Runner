...
/**
 * FeedbackClient - API client for backend communication
 * @module services/FeedbackClient
 */
...
export class FeedbackClient extends EventEmitter {
  private opts: FeedbackClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FeedbackClientOptions> = {}) {
    super();
