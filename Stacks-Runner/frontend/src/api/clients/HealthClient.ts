...
/**
 * HealthClient - API client for backend communication
 * @module services/HealthClient
 */
...
export class HealthClient extends EventEmitter {
  private opts: HealthClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<HealthClientOptions> = {}) {
    super();
