...
/**
 * GuildClient - API client for backend communication
 * @module services/GuildClient
 */
...
export class GuildClient extends EventEmitter {
  private opts: GuildClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<GuildClientOptions> = {}) {
    super();
