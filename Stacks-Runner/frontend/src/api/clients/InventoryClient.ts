...
/**
 * InventoryClient - API client for backend communication
 * @module services/InventoryClient
 */
...
export class InventoryClient extends EventEmitter {
  private opts: InventoryClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<InventoryClientOptions> = {}) {
    super();
