...
/**
 * ExplosionEffect - Visual effect renderer
 * @module services/ExplosionEffect
 */
...
export class ExplosionEffect extends EventEmitter {
  private opts: ExplosionEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ExplosionEffectOptions> = {}) {
    super();
