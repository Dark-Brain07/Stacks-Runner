...
/**
 * SnowEffect - Visual effect renderer
 * @module services/SnowEffect
 */
...
export class SnowEffect extends EventEmitter {
  private opts: SnowEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SnowEffectOptions> = {}) {
    super();
