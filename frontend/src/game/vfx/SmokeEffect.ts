...
/**
 * SmokeEffect - Visual effect renderer
 * @module services/SmokeEffect
 */
...
export class SmokeEffect extends EventEmitter {
  private opts: SmokeEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SmokeEffectOptions> = {}) {
    super();
