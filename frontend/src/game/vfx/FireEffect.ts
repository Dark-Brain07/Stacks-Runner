...
/**
 * FireEffect - Visual effect renderer
 * @module services/FireEffect
 */
...
export class FireEffect extends EventEmitter {
  private opts: FireEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FireEffectOptions> = {}) {
    super();
