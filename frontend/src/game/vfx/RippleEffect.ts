...
/**
 * RippleEffect - Visual effect renderer
 * @module services/RippleEffect
 */
...
export class RippleEffect extends EventEmitter {
  private opts: RippleEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<RippleEffectOptions> = {}) {
    super();
