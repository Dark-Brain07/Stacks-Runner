...
/**
 * GlowEffect - Visual effect renderer
 * @module services/GlowEffect
 */
...
export class GlowEffect extends EventEmitter {
  private opts: GlowEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<GlowEffectOptions> = {}) {
    super();
