...
/**
 * RainEffect - Visual effect renderer
 * @module services/RainEffect
 */
...
export class RainEffect extends EventEmitter {
  private opts: RainEffectOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<RainEffectOptions> = {}) {
    super();
