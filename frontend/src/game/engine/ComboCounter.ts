...
/**
 * ComboCounter - Game engine subsystem
 * @module services/ComboCounter
 */
...
export class ComboCounter extends EventEmitter {
  private opts: ComboCounterOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ComboCounterOptions> = {}) {
    super();
