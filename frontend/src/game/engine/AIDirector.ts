...
/**
 * AIDirector - Game engine subsystem
 * @module services/AIDirector
 */
...
export class AIDirector extends EventEmitter {
  private opts: AIDirectorOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<AIDirectorOptions> = {}) {
    super();
