...
/**
 * FogOfWar - Game engine subsystem
 * @module services/FogOfWar
 */
...
export class FogOfWar extends EventEmitter {
  private opts: FogOfWarOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FogOfWarOptions> = {}) {
    super();
