...
/**
 * MinimapRenderer - Game engine subsystem
 * @module services/MinimapRenderer
 */
...
export class MinimapRenderer extends EventEmitter {
  private opts: MinimapRendererOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<MinimapRendererOptions> = {}) {
    super();
