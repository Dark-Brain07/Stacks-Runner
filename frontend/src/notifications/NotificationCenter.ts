...
/**
 * NotificationCenter - Notification system component
 * @module services/NotificationCenter
 */
...
export class NotificationCenter extends EventEmitter {
  private opts: NotificationCenterOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<NotificationCenterOptions> = {}) {
    super();
