...
/**
 * ThrottleGuard - Notification system component
 * @module services/ThrottleGuard
 */
...
export class ThrottleGuard extends EventEmitter {
  private opts: ThrottleGuardOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ThrottleGuardOptions> = {}) {
    super();
