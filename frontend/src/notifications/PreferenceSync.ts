...
/**
 * PreferenceSync - Notification system component
 * @module services/PreferenceSync
 */
...
export class PreferenceSync extends EventEmitter {
  private opts: PreferenceSyncOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<PreferenceSyncOptions> = {}) {
    super();
