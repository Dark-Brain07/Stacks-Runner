...
/**
 * ArchiveManager - Notification system component
 * @module services/ArchiveManager
 */
...
export class ArchiveManager extends EventEmitter {
  private opts: ArchiveManagerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ArchiveManagerOptions> = {}) {
    super();
