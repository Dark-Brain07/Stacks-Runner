...
/**
 * InAppBanner - Notification system component
 * @module services/InAppBanner
 */
...
export class InAppBanner extends EventEmitter {
  private opts: InAppBannerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<InAppBannerOptions> = {}) {
    super();
