...
/**
 * SnoozeManager - Notification system component
 * @module services/SnoozeManager
 */
export interface SnoozeManagerOptions {
  enabled: boolean;
  maxRetries: number;
  timeoutMs: number;
  batchSize: number;
...
export class SnoozeManager extends EventEmitter {
  private opts: SnoozeManagerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SnoozeManagerOptions> = {}) {
    super();
