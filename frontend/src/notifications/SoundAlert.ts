...
/**
 * SoundAlert - Notification system component
 * @module services/SoundAlert
 */
...
export class SoundAlert extends EventEmitter {
  private opts: SoundAlertOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SoundAlertOptions> = {}) {
    super();
