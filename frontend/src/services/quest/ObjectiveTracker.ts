...
/**
 * ObjectiveTracker - Quest and progression service
 * @module services/ObjectiveTracker
 */
...
export class ObjectiveTracker extends EventEmitter {
  private opts: ObjectiveTrackerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ObjectiveTrackerOptions> = {}) {
    super();
