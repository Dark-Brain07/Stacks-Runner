...
/**
 * MasteryTracker - Quest and progression service
 * @module services/MasteryTracker
 */
...
export class MasteryTracker extends EventEmitter {
  private opts: MasteryTrackerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<MasteryTrackerOptions> = {}) {
    super();
