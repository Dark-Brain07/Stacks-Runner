...
/**
 * BranchingQuest - Quest and progression service
 * @module services/BranchingQuest
 */
export interface BranchingQuestOptions {
  enabled: boolean;
  maxRetries: number;
  timeoutMs: number;
  batchSize: number;
...
export class BranchingQuest extends EventEmitter {
  private opts: BranchingQuestOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<BranchingQuestOptions> = {}) {
    super();
