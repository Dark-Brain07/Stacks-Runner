...
/**
 * BattlePass - Quest and progression service
 * @module services/BattlePass
 */
...
export class BattlePass extends EventEmitter {
  private opts: BattlePassOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<BattlePassOptions> = {}) {
    super();
