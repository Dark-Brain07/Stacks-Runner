...
/**
 * LongTaskObserver - Performance monitoring module
 * @module services/LongTaskObserver
 */
...
export class LongTaskObserver extends EventEmitter {
  private opts: LongTaskObserverOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<LongTaskObserverOptions> = {}) {
    super();
