...
/**
 * FrameTimeline - Performance monitoring module
 * @module services/FrameTimeline
 */
...
export class FrameTimeline extends EventEmitter {
  private opts: FrameTimelineOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FrameTimelineOptions> = {}) {
    super();
