...
/**
 * ResourceTiming - Performance monitoring module
 * @module services/ResourceTiming
 */
...
export class ResourceTiming extends EventEmitter {
  private opts: ResourceTimingOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ResourceTimingOptions> = {}) {
    super();
