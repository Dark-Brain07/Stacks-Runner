...
/**
 * JankDetector - Performance monitoring module
 * @module services/JankDetector
 */
...
export class JankDetector extends EventEmitter {
  private opts: JankDetectorOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<JankDetectorOptions> = {}) {
    super();
