...
/**
 * BundleResolver - Economy and inventory management
 * @module services/BundleResolver
 */
...
export class BundleResolver extends EventEmitter {
  private opts: BundleResolverOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<BundleResolverOptions> = {}) {
    super();
