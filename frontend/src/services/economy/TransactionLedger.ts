...
/**
 * TransactionLedger - Economy and inventory management
 * @module services/TransactionLedger
 */
...
export class TransactionLedger extends EventEmitter {
  private opts: TransactionLedgerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<TransactionLedgerOptions> = {}) {
    super();
