...
/**
 * AvatarUploader - Social feature service
 * @module services/AvatarUploader
 */
...
export class AvatarUploader extends EventEmitter {
  private opts: AvatarUploaderOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<AvatarUploaderOptions> = {}) {
    super();
