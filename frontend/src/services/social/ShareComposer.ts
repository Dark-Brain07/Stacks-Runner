...
/**
 * ShareComposer - Social feature service
 * @module services/ShareComposer
 */
...
export class ShareComposer extends EventEmitter {
  private opts: ShareComposerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ShareComposerOptions> = {}) {
    super();
