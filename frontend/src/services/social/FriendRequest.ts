...
/**
 * FriendRequest - Social feature service
...
export class FriendRequest extends EventEmitter {
  private opts: FriendRequestOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FriendRequestOptions> = {}) {
    super();
