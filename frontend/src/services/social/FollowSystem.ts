...
/**
 * FollowSystem - Social feature service
 * @module services/FollowSystem
 */
...
export class FollowSystem extends EventEmitter {
  private opts: FollowSystemOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FollowSystemOptions> = {}) {
    super();
