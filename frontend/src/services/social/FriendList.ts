...
/**
 * FriendList - Social feature service
 * @module services/FriendList
 */
...
export class FriendList extends EventEmitter {
  private opts: FriendListOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FriendListOptions> = {}) {
    super();
