...
/**
 * SocialGraph - Social feature service
 * @module services/SocialGraph
 */
...
export class SocialGraph extends EventEmitter {
  private opts: SocialGraphOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SocialGraphOptions> = {}) {
    super();
