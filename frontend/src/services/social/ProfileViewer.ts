...
/**
 * ProfileViewer - Social feature service
 * @module services/ProfileViewer
 */
...
export class ProfileViewer extends EventEmitter {
  private opts: ProfileViewerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ProfileViewerOptions> = {}) {
    super();
