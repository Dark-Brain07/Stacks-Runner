...
/**
 * LatencyMonitor - Multiplayer networking service
 * @module services/LatencyMonitor
 */
...
export class LatencyMonitor extends EventEmitter {
  private opts: LatencyMonitorOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<LatencyMonitorOptions> = {}) {
    super();
