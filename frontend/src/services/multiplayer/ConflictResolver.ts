...
/**
 * ConflictResolver - Multiplayer networking service
 * @module services/ConflictResolver
 */
...
export class ConflictResolver extends EventEmitter {
  private opts: ConflictResolverOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ConflictResolverOptions> = {}) {
    super();
