...
/**
 * SessionCoordinator - Multiplayer networking service
 * @module services/SessionCoordinator
 */
...
export class SessionCoordinator extends EventEmitter {
  private opts: SessionCoordinatorOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SessionCoordinatorOptions> = {}) {
    super();
