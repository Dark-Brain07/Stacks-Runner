...
/**
 * SocialClient - API client for backend communication
 * @module services/SocialClient
 */
...
export class SocialClient extends EventEmitter {
  private opts: SocialClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<SocialClientOptions> = {}) {
    super();
