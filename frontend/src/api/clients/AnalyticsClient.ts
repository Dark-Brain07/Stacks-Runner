...
/**
 * AnalyticsClient - API client for backend communication
 * @module services/AnalyticsClient
 */
...
export class AnalyticsClient extends EventEmitter {
  private opts: AnalyticsClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<AnalyticsClientOptions> = {}) {
    super();
