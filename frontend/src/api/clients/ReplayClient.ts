...
/**
 * ReplayClient - API client for backend communication
 * @module services/ReplayClient
 */
...
export class ReplayClient extends EventEmitter {
  private opts: ReplayClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ReplayClientOptions> = {}) {
    super();
