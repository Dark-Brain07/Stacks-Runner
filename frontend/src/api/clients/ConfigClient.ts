...
/**
 * ConfigClient - API client for backend communication
 * @module services/ConfigClient
 */
...
export class ConfigClient extends EventEmitter {
  private opts: ConfigClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ConfigClientOptions> = {}) {
    super();
