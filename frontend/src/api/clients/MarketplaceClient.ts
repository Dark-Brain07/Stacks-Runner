...
/**
 * MarketplaceClient - API client for backend communication
 * @module services/MarketplaceClient
 */
...
export class MarketplaceClient extends EventEmitter {
  private opts: MarketplaceClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<MarketplaceClientOptions> = {}) {
    super();
