...
/**
 * ReportClient - API client for backend communication
 * @module services/ReportClient
 */
...
export class ReportClient extends EventEmitter {
  private opts: ReportClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<ReportClientOptions> = {}) {
    super();
