...
/**
 * TournamentClient - API client for backend communication
 * @module services/TournamentClient
 */
...
export class TournamentClient extends EventEmitter {
  private opts: TournamentClientOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<TournamentClientOptions> = {}) {
    super();
