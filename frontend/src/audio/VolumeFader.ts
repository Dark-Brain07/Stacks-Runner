...
/**
 * VolumeFader - Audio system component
 * @module services/VolumeFader
 */
...
export class VolumeFader extends EventEmitter {
  private opts: VolumeFaderOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<VolumeFaderOptions> = {}) {
    super();
