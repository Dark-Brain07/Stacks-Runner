...
/**
 * DuckingManager - Audio system component
 * @module services/DuckingManager
 */
export interface DuckingManagerOptions {
  enabled: boolean;
  maxRetries: number;
  timeoutMs: number;
  batchSize: number;
...
export class DuckingManager extends EventEmitter {
  private opts: DuckingManagerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<DuckingManagerOptions> = {}) {
    super();
