...
/**
 * FrequencyAnalyzer - Audio system component
 * @module services/FrequencyAnalyzer
 */
...
export class FrequencyAnalyzer extends EventEmitter {
  private opts: FrequencyAnalyzerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<FrequencyAnalyzerOptions> = {}) {
    super();
