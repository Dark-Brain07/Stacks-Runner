...
/**
 * Equalizer - Audio system component
 * @module services/Equalizer
 */
...
export class Equalizer extends EventEmitter {
  private opts: EqualizerOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<EqualizerOptions> = {}) {
    super();
