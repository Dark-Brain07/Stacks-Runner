...
/**
 * CSPBuilder - Security and authentication module
 * @module services/CSPBuilder
 */
...
export class CSPBuilder extends EventEmitter {
  private opts: CSPBuilderOptions;
  private active = false;
  private metrics = { calls: 0, errors: 0, latencySum: 0 };

  constructor(opts: Partial<CSPBuilderOptions> = {}) {
    super();
